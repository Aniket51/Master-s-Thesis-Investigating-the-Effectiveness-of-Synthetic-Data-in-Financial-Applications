...
from testing.metrics.discriminative_metrics import discriminative_score_metrics
...
# python3 main_timegan.py --data_name prism --seq_len 10 --module gru --hidden_dim 3 --num_layer 3 --iteration 5 --batch_size 4 --loss bce --metric_iteration 3
