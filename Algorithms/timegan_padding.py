...
from timeGAN.merge.metrics.utils import extract_time, rnn_cell, random_generator, batch_generator
...
data_name = 'prism_padding'
seq_len = 2171

if data_name in ['stock', 'energy', 'prism', 'prism_padding']:
